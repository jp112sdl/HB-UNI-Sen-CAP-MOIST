...
#define SENSOR_PIN_FROM    14
#define SENSOR_EN_PIN_FROM 5
...
class WeatherChannel : public Channel<Hal, UList1, EmptyList, List4, PEERS_PER_CHANNEL, UList0>, public Alarm {
  ...
  public:
    ...
    void configChanged() {
      ...
      DPRINT("*HIGHValue: "); DDECLN(this->getList1().HIGHValue());
      DPRINT("*LOWValue: "); DDECLN(this->getList1().LOWValue());
    }
...
class UType : public MultiChannelDevice<Hal, WeatherChannel, SENSOR_COUNT, UList0> {
  public:
    typedef MultiChannelDevice<Hal, WeatherChannel, SENSOR_COUNT, UList0> TSDevice;
